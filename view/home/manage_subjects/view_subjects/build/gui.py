...
from view.home.manage_subjects.view_subjects.edit_subject.build.gui import edit_Subject_Window
...
def view_Subjects_Window():
    View_Subjects()

class View_Subjects(Toplevel):
    ...
    def openEditSubject(self):
        edit_Subject_Window(self, self.selected_rid)
